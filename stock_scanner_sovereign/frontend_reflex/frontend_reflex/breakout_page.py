...
from .components.breakout_grid import breakout_alpha_feed, breakout_data_grid
...
def breakout_page():
    return rx.box(
        rx.hstack(
            ...
            rx.vstack(
                breakout_alpha_feed(), breakout_data_grid(),
                ...
                spacing="0", width="100%", height="100vh", background_color="#000000"
            ), width="100%", height="100vh", spacing="0", background_color="#000000"
        ), width="100%", font_family="'JetBrains Mono', monospace",
    )
