...
def universe_panel():
    return rx.vstack(
        ...
        rx.button("SIDECAR BREAKOUT CLOCK (DAILY)", on_click=State.open_breakout_clock_daily_full_universe, variant="ghost", color="#00E5FF", width="100%", text_align="left", justify_content="start", padding_x="15px", height="35px"),
        rx.button("SIDECAR BREAKOUT CLOCK (WEEKLY)", on_click=State.open_breakout_clock_weekly_full_universe, variant="ghost", color="#66CCFF", width="100%", text_align="left", justify_content="start", padding_x="15px", height="35px"),
