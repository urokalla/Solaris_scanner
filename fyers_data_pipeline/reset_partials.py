...
from fyers_data_pipeline.src.db_manager import DatabaseManager

def reset_partials():
    nifty500_path = '/home/udai/RS_PROJECT/stock_scanner_sovereign/data/nifty500.csv'
    hist_dir = '/home/udai/RS_PROJECT/fyers_data_pipeline/data/historical'
